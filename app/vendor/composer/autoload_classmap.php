...
return array(
    ...
    'App\\Exceptions\\Handler' => $baseDir . '/app/Admin/Extensions/Handler.php',
    ...
    'OpenAdmin\\Admin\\Helpers\\Controllers\\StringOutput' => $vendorDir . '/open-admin-ext/helpers/src/Controllers/TerminalController.php',
    ...
    'OpenAdmin\\Admin\\RedisManager\\BootExtension' => $vendorDir . '/open-admin-ext/redis-manager/src/BootExtension.php',
    'OpenAdmin\\Admin\\RedisManager\\DataType\\DataType' => $vendorDir . '/open-admin-ext/redis-manager/src/DataType/DataType.php',
    'OpenAdmin\\Admin\\RedisManager\\DataType\\Hashes' => $vendorDir . '/open-admin-ext/redis-manager/src/DataType/Hashes.php',
    'OpenAdmin\\Admin\\RedisManager\\DataType\\Lists' => $vendorDir . '/open-admin-ext/redis-manager/src/DataType/Lists.php',
    'OpenAdmin\\Admin\\RedisManager\\DataType\\Sets' => $vendorDir . '/open-admin-ext/redis-manager/src/DataType/Sets.php',
    'OpenAdmin\\Admin\\RedisManager\\DataType\\SortedSets' => $vendorDir . '/open-admin-ext/redis-manager/src/DataType/SortedSets.php',
    'OpenAdmin\\Admin\\RedisManager\\DataType\\Strings' => $vendorDir . '/open-admin-ext/redis-manager/src/DataType/Strings.php',
    'OpenAdmin\\Admin\\RedisManager\\RedisController' => $vendorDir . '/open-admin-ext/redis-manager/src/RedisController.php',
    'OpenAdmin\\Admin\\RedisManager\\RedisManager' => $vendorDir . '/open-admin-ext/redis-manager/src/RedisManager.php',
    'OpenAdmin\\Admin\\RedisManager\\RedisManagerServiceProvider' => $vendorDir . '/open-admin-ext/redis-manager/src/RedisManagerServiceProvider.php',
    'OpenAdmin\\Admin\\Reporter\\Actions\\ViewReport' => $vendorDir . '/open-admin-ext/reporter/src/Actions/ViewReport.php',
    'OpenAdmin\\Admin\\Reporter\\BootExtension' => $vendorDir . '/open-admin-ext/reporter/src/BootExtension.php',
    'OpenAdmin\\Admin\\Reporter\\ExceptionController' => $vendorDir . '/open-admin-ext/reporter/src/ExceptionController.php',
    'OpenAdmin\\Admin\\Reporter\\ExceptionModel' => $vendorDir . '/open-admin-ext/reporter/src/ExceptionModel.php',
    'OpenAdmin\\Admin\\Reporter\\Reporter' => $vendorDir . '/open-admin-ext/reporter/src/Reporter.php',
    'OpenAdmin\\Admin\\Reporter\\ReporterServiceProvider' => $vendorDir . '/open-admin-ext/reporter/src/ReporterServiceProvider.php',
    'OpenAdmin\\Admin\\Reporter\\Tracer\\CodeBlock' => $vendorDir . '/open-admin-ext/reporter/src/Tracer/CodeBlock.php',
    'OpenAdmin\\Admin\\Reporter\\Tracer\\Frame' => $vendorDir . '/open-admin-ext/reporter/src/Tracer/Frame.php',
    'OpenAdmin\\Admin\\Reporter\\Tracer\\Parser' => $vendorDir . '/open-admin-ext/reporter/src/Tracer/Parser.php',
    ...
    'OpenAdmin\\PHPInfo\\Http\\Controllers\\PHPInfoController' => $vendorDir . '/open-admin-ext/phpinfo/src/Http/Controllers/PHPInfoController.php',
    'OpenAdmin\\PHPInfo\\PHPInfo' => $vendorDir . '/open-admin-ext/phpinfo/src/PHPInfo.php',
    'OpenAdmin\\PHPInfo\\PHPInfoServiceProvider' => $vendorDir . '/open-admin-ext/phpinfo/src/PHPInfoServiceProvider.php',
